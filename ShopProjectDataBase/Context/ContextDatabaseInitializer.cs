...
{
    public static class ContextDatabaseInitializer  
    {
        public  static void Initial(this ContextDataBase context,UserEntity user)
        {  
            if(context.Users != null)
            {
                user.UserRole = new UserRoleEntity() { NameRole = "Admin", TypeAccess = 0 };
