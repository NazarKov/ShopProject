...
namespace ShopProjectDataBase.Migrations
{
    ...
    [Migration("20260614223848_DeleteOperationRecorderAndUserTableAddTaxObjectUserRenameObjectOwnerToTaxObject")]
    partial class DeleteOperationRecorderAndUserTableAddTaxObjectUserRenameObjectOwnerToTaxObject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShopProjectDataBase.Entities.OperationEntity", b =>
                {
                    ...
                    b.Property<string>("FiscalServerId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
