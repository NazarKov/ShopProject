...
namespace ShopProject.Services.Integration.PrintingService
{
    internal class PrintingSticker : IPrintingStikerService
    { 
        ...
        public PrintingSticker (ISettingService settingService)
        {
        ...
        public BitmapImage CreateSticker(string company, string name, string description, string code, bool isValidation = false)
        {
            try
            {
                if (isValidation)
        ...
        public bool PrintSticker()
        {
            try
            {
                 ...
                 var printer = _settingService.GetSetting<PrinterStickerSetting>().Printer;
        ...
        {
            return CreateSticker(company, name, description, code, true);
        }
