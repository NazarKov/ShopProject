...
namespace ShopProject.Services.Modules.ModelService.OperationRecorder
{
    internal class OperationRecorderServise : IOperationRecorderServise
    {
        ...
        public async Task<Paginator<ShopProject.Model.Domain.OperationRecorder.OperationRecorder, TypeStatusOperationRecorder>> GetOperationsRecorderPageColumn(int page, int countColumn, TypeStatusOperationRecorder status)
        {
            try
            {
                ...
                var paginator = new Paginator<ShopProject.Model.Domain.OperationRecorder.OperationRecorder, TypeStatusOperationRecorder>()
                {
            ...
            catch (Exception ex)
            {
                ...
                return new Paginator<ShopProject.Model.Domain.OperationRecorder.OperationRecorder, TypeStatusOperationRecorder>();
            }
        }

        public async Task<Paginator<ShopProject.Model.Domain.OperationRecorder.OperationRecorder, TypeStatusOperationRecorder>> SearchByName(string item, int page, int countColumn, TypeStatusOperationRecorder status)
        {
            try
            {
