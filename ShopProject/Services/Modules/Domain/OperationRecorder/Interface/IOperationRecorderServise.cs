...
namespace ShopProject.Services.Modules.ModelService.OperationRecorder.Interface
{
    internal interface IOperationRecorderServise
    {
        ...
        public  Task<Paginator<ShopProject.Model.Domain.OperationRecorder.OperationRecorder,TypeStatusOperationRecorder>> GetOperationsRecorderPageColumn(int page, int countColumn, TypeStatusOperationRecorder status);
        public  Task<Paginator<ShopProject.Model.Domain.OperationRecorder.OperationRecorder, TypeStatusOperationRecorder>> SearchByName(string item, int page, int countColumn, TypeStatusOperationRecorder status);
