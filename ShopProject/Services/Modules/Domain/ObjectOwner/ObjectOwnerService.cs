...
namespace ShopProject.Services.Modules.ModelService.ObjectOwner
{
    internal class ObjectOwnerService : IObjectOwnerService
    {
        ...
        public async Task<Paginator<ShopProject.Model.Domain.ObjectOwner.ObjectOwner, TypeStatusObjectOwner>> GetObjectOwnerPageColumn(int page, int countColumn, TypeStatusObjectOwner status)
        {
            try
            {
                ...
                var paginator = new Paginator<ShopProject.Model.Domain.ObjectOwner.ObjectOwner, TypeStatusObjectOwner>()
                {
            ...
            catch (Exception ex)
            {
                ...
                return new Paginator<ShopProject.Model.Domain.ObjectOwner.ObjectOwner, TypeStatusObjectOwner>();
            }
        }

        public async Task<Paginator<ShopProject.Model.Domain.ObjectOwner.ObjectOwner, TypeStatusObjectOwner>> SearchByName(string item, int page, int countColumn, TypeStatusObjectOwner status)
        {
            try
            {
