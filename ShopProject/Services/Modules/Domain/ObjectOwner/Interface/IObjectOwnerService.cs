...
namespace ShopProject.Services.Modules.ModelService.ObjectOwner.Interface
{
    ...
    {
        public Task<Paginator<ShopProject.Model.Domain.ObjectOwner.ObjectOwner,TypeStatusObjectOwner>> GetObjectOwnerPageColumn(int page, int countColumn, TypeStatusObjectOwner status);
        public Task<Paginator<ShopProject.Model.Domain.ObjectOwner.ObjectOwner, TypeStatusObjectOwner>> SearchByName(string item, int page, int countColumn, TypeStatusObjectOwner status);
