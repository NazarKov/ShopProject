...
using ShopProject.Services.Modules.Mapping.GiftCertificate;
...
namespace ShopProject.Services.Modules.ModelService.GiftCertificate
{
    internal class GiftCertificatesServise : IGiftCertificatesServise
    {
        ...
        public async Task<Paginator<ShopProject.Model.Domain.GiftCertificate.GiftCertificate,TypeStatusGiftCertificate>> GetGiftCertificatePageColumn(int page, int countColumn, TypeStatusGiftCertificate status)
        {
            try
            {
                ...
                var paginator = new Paginator<ShopProject.Model.Domain.GiftCertificate.GiftCertificate, TypeStatusGiftCertificate>()
                {
            ...
            catch (Exception ex)
            {
                ...
                return new Paginator<ShopProject.Model.Domain.GiftCertificate.GiftCertificate, TypeStatusGiftCertificate>();
            }
        }

        public async Task<Paginator<ShopProject.Model.Domain.GiftCertificate.GiftCertificate, TypeStatusGiftCertificate>> SearchByName(string item, int page, int countColumn, TypeStatusGiftCertificate status)
        {
            try
            {
