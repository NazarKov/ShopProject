...
{
    public static class ApiOperationMappingExtensions
    {
        public static CreateOperationDto ToCreateOperationDto(this ShopProject.Model.Domain.Operation.Operation operation)
        {
        ...
        public static ShopProject.Model.Domain.Operation.Operation ToOperation(this OperationDto operation)
        {
            var result = new ShopProject.Model.Domain.Operation.Operation()
            {
                FiscalServerId = operation.FiscalServerId,
                BuyersAmount = operation.BuyersAmount,
                CreatedAt = operation.CreatedAt,
