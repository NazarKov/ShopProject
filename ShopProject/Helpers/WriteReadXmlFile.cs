...
namespace ShopProject.Helpers
{
    public static class WriteReadXmlFile
    {
        ...
        private static void WriteHeader(OperationEntiti operation , XmlTextWriter writer)
        {
        ...
        private static void WriteFooter(OperationEntiti operation, XmlTextWriter writer)
        {
        ...
        private static void WriteElementCT0(OperationEntiti operation,List<OrderEntiti> goods, XmlTextWriter writer)
        {
        ...
        private static void WriteElementCT0_1(OperationEntiti operation,List<ProductEntiti> goods, XmlTextWriter writer)
        {
            writer.WriteStartElement("C");
            writer.WriteAttributeString("T", operation.TypeOperation.ToString("0"));
        ...
        private static void WriteElementCT2(OperationEntiti operation , XmlTextWriter writer, bool type)
        {
            writer.WriteStartElement("C");
            writer.WriteAttributeString("T", operation.TypeOperation.ToString("0"));
        ...
        private static void WriteElementCT108(OperationEntiti operation, XmlTextWriter writer)
        {
        ...
        private static void WriteElementZ(OperationEntiti operation, XmlTextWriter writer)
        {
        ...
        public static void WriteXmlFile(OperationEntiti operation, List<OrderEntiti> goodsOperation,List<ProductEntiti> goods, string path)
        {
