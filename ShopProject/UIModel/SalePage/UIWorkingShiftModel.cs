...
{   public class UIWorkingShiftModel
    {
        ...
        /// </summary> 
        public UIMediaAccessControlModel MACCreateAt { get; set; }
        /// <summary>
        /// hesh закриття зміни
        /// </summary> 
        public UIMediaAccessControlModel MACEndAt { get; set; }
        /// <summary>
        /// час відриття зміної
        /// </summary>
        ...
        /// </summary>
        public IEnumerable<UIOperationModel>? Operations { get; set; }
    }
}
